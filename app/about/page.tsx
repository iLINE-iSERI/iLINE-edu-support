...
const DRAFT = {
  purpose:
    // ⚠️ 끝에 "갤러리를 통해 공유됩니다"가 있었는데 **갤러리는 1차 오픈에서
    //    메뉴를 내렸다**(D-47). 없는 것을 약속하지 않도록 뺐다.
    //    갤러리를 열게 되면 그때 다시 넣는다.
    '예비교원이 교육 현장에 나가기 전에 인공지능 교육을 직접 설계하고 실습해 볼 수 있도록 프로그램 참여와 자료 개발, 활동비를 지원합니다.',
  // 대상 = 예비교원 (확정)
