 ...
 *
 * ── 가장 중요한 안내 ─────────────────────────────────────────
 * **이미 제출한 신청서의 신청자 정보는 바뀌지 않는다.** 신청서는 제출 시점의
 * 원본이라 정보를 사본으로 들고 있기 때문이다(D-28). 이걸 말해주지 않으면
 * 신청자는 여기서 고치면 신청서도 고쳐지는 줄 안다. 신청서 **내용**은 D-73 부터
 * 마감 전 마이페이지에서 고칠 수 있다 — 그 안내도 함께 한다.
 */
      ...
      <div className="mx-auto w-full max-w-2xl px-4 pb-16">
        ...
        <div className="rounded-2xl border border-line bg-subtle p-4 text-sm leading-relaxed">
          <p className="font-bold">
            이미 제출한 신청서의 신청자 정보는 바뀌지 않습니다.
          </p>
          <p className="mt-1 text-ink-muted">
            신청서는 <strong>제출하신 그 시점의 원본</strong>으로 보관됩니다.
            여기서 정보를 고쳐도 지난 신청서의 이름·학년·연락처는 그대로
            남습니다. 신청서의 <strong>내용</strong>
            (프로그램별 항목·기재란)은 접수 마감 전까지 마이페이지에서 직접 고칠
            수 있고, 신청자 정보까지 바꿔야 한다면 취소 후 다시 신청하시거나
            담당자에게 문의해 주세요.
          </p>
        ...
        <dl className="mt-4 rounded-2xl border border-line bg-surface shadow-card p-5 text-sm">
        ...
        <p className="mt-3 text-xs leading-relaxed text-ink-subtle">
          가입 유형을 바꾸시면 그 유형에서 쓰지 않는 항목(학번·학년 또는 직위)은{' '}
          <strong>비워져서 저장됩니다.</strong>
        </p>

        <div className="mt-6 text-center">
          <Button variant="text" href="/mypage">
            취소하고 돌아가기
          </Button>
        </div>
      </div>
