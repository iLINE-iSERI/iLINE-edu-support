    ...
    <>
      ...
      <div className="mx-auto w-full max-w-2xl px-4 pb-16">
        ...
        <div className="rounded-2xl border border-line bg-subtle p-4 text-sm leading-relaxed">
          <p className="font-bold">이미 제출한 신청서의 신청자 정보는 바뀌지 않습니다.</p>
          <p className="mt-1 text-ink-muted">
            신청서는 <strong>제출하신 그 시점의 원본</strong>으로 보관됩니다.
            여기서 정보를 고쳐도 지난 신청서의 이름·학년·연락처는 그대로 남습니다.
            신청서의 <strong>내용</strong>(프로그램별 항목·기재란)은 접수 마감 전까지
            마이페이지에서 직접 고칠 수 있고, 신청자 정보까지 바꿔야 한다면 취소 후
            다시 신청하시거나 담당자에게 문의해 주세요.
          </p>
