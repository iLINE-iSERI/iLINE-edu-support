 ...
 *
 * 검토 시 확인할 것 (docs/3-할일/01-남은-일.md D항목 Q-7과 연결)
 *  · 개인정보 보호책임자 지정 및 연락처
 *  · 보유기간이 사업 규정·법령과 맞는지
...
const SECTIONS = [
  {
    ...
    body: [
      ...
      '시설 예약 시: 예약한 공간·자리·일시 (신청자 정보는 등록된 회원 정보를 그대로 사용하며 새로 받지 않습니다)',
  ...
  },
  {
    ...
    body: [
      ...
      '활동비 정산 및 지급',
      '사업 성과 관리 및 결과 보고',
      // 09-12 시설 예약 기능 추가에 따라 (D-52·D-56). 행정실 전달은 명단 화면으로
      // 담당자가 보내는 것이라 "제공"으로 적을지는 A-4 기관 검토 대상.
      '공부실 등 시설 예약 접수 및 이용 관리 — 사용 요청을 위해 예약자의 이름·소속·연락처를 사범대학 행정실에 전달',
    ],
  },
  {
    title: '3. 보유 및 이용 기간',
  ...
  },
  {
    title: '8. 개인정보 보호책임자',
    body: [
      // ⚠️ 여기는 **개인정보 관련 문의**만 받는 곳이다.
      //    프로그램·사업 문의는 푸터의 `SITE.contact`(ai_edu@ / 754-1876)로 간다.
      //    용도를 안 적으면 학생들이 프로그램 문의를 보호책임자에게 건다.
      '개인정보의 열람·정정·삭제·처리정지 요구 등 개인정보 처리에 관한 문의는 아래로 연락해 주시기 바랍니다.',
      '운영 기관: 제주대학교 지능소프트웨어교육연구소',
      '개인정보 보호책임자: 배진아',
      '전화: 064-754-1870',
      '이메일: jina@jejunu.ac.kr',
      '※ 프로그램 신청·정산 등 사업 관련 문의는 화면 아래쪽의 문의처를 이용해 주세요.',
    ],
  },
]
