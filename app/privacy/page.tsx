...
const SECTIONS = [
  {
    ...
    body: [
      '회원 등록 시: 성명, 소속, 학과·전공, 신분 정보(학번·학년 또는 직위), 연락처, 이메일',
      '프로그램 신청 시: 위 회원 정보의 사본, 초상권 활용 동의 여부, 프로그램이 요구하는 경우 자유 기재 사항 및 첨부 파일',
      '정산 시: 은행명·계좌번호·예금주, 영수증 등 지출 증빙 서류',
      '자동 수집: 서비스 이용 기록, 접속 로그',
      '신분증 사본·통장 사본 등 민감 서류는 수집하지 않습니다.',
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      '지급 계좌 정보는 외부 서비스(구글 스프레드시트·드라이브)로 내보내지 않으며, 본 사이트 안에서만 열람합니다.',
    ],
  },
  {
    title: '8. 개인정보 보호책임자',
