...
const FAQ = [
  ...
  },
  {
    ...
    a: '사이트에서는 다음 주 이후의 평일 09~18시만 예약할 수 있습니다. 당일 이용, 이용 당일에 시간을 더 쓰는 것, 주말과 18시 이후 이용, 여러 명이 함께 쓰는 단체 이용은 사이트에서 신청받지 않지만 이용이 불가능한 것은 아닙니다 — 아래 문의처로 연락하시면 가능한 경우가 있습니다.',
  },
  {
