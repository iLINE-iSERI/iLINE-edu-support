 ...
 * 확인한 것이다 (J-1).
 *
 * ✅ 운영 시간 **09~18시 확인 완료 (09-17 iSERI · J-2)**. 마지막 칸은 17시 시작,
 *    2시간은 16시 시작까지. 더 이상 가정값이 아니다.
 *
 * 🔵 2334 정원은 비워 둔다 — iSERI(09-17): *"공간 자체를 제공하고 알아서 활용하게
 *    한다고 생각하세요."* 인원을 세어 보여 줄 일이 없으므로 `capacity: 0` 이 맞다.
 */
